<template>
   <div>
        <div class='container' v-if="display1">
            <div class="icon" v-for="(item,index) in arrSlice1" :key="index" @click="jump(index,router)">
                    <div class="avatar">
            ...
            <div class="bnt" v-if="arr.length > 9" v-show="isShow">
                <div class="bnt1" @click="show"></div>
                <div class="bnt2" @click="show"></div>
            </div>
        </div>
        <div class='container' v-show="isShow" v-if="display2">
            <div class="icon" v-for="(item,key) in arrSlice2" :key="key">
                <div class="avatar">
                    <image style="width:84px;height:84px;" resize="stretch" src="http://img2.imgtn.bdimg.com/it/u=3830392766,3562967206&fm=26&gp=0.jpg"/>
                </div>
                <text class="text1">{{item}}</text>
